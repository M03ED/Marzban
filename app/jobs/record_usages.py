...
scheduler.add_job(record_user_usages, 'interval', coalesce=True, seconds=10, max_instances=1)
scheduler.add_job(record_node_usages, 'interval', coalesce=True, seconds=5, max_instances=1)
